<div>
    ...
    <div className='flex justify-center'>
        <div className=' flex  flex-col items-start  md:mx-4 sm:mx-2 bg-gray-200  w-full '>
            <div className='m-6'>
                {role === "partner" && (
            ...
            <div className='w-full flex '>
                ...
                <div className='sm:w-1/2 h-32 mr-2'>
                    <img className='object-cover md:w-full rounded-md md:h-[400px] sm:h-[300px]' src={property.propertyImage[0] ? property.propertyImage[0] : "/src/assets/noBuliding.png"} alt=" 1 Image not found" />
                </div>

                <div className='w-1/2 grid md:grid-cols-2 sm:grid-cols-1 gap-2'>
...
c0.6,0,1-0.4,1-1s-0.4-1-1-1H7.1v-1.6h1.1c0.6,0,1-0.4,1-1s-0.4-1-1-1H7.1v-4L46.3,54z"></path><path d="M14.1 48h15.3c.4 0 .8-.2.9-.6s.1-.8-.2-1.1L14.8 31c-.3-.3-.7-.4-1.1-.2-.4.2-.6.5-.6.9V47C13.1 47.6 13.5 48 14.1 48zM15.1 34.1L27 46H15.1V34.1zM20.8 6.3c-.4-.4-1-.4-1.4 0l-6 6c-.4.4-.4 1 0 1.4l2.6 2.6c0 0 0 0 0 0s0 0 0 0l3.2 3.2c0 0 0 0 0 0s0 0 0 0l3.2 3.2c0 0 0 0 0 0s0 0 0 0l3.2 3.2c0 0 0 0 0 0s0 0 0 0l3.2 3.2c0 0 0 0 0 0s0 0 0 0l3.2 3.2c0 0 0 0 0 0s0 0 0 0l3.2 3.2c0 0 0 0 0 0s0 0 0 0l3.2 3.2c0 0 0 0 0 0s0 0 0 0l3.2 3.2c0 0 0 0 0 0s0 0 0 0l3.2 3.2c0 0 0 0 0 0s0 0 0 0l2.6 2.6c.2.2.5.3.7.3s.5-.1.7-.3l6-6c.4-.4.4-1 0-1.4L20.8 6.3zM48.1 45.6l-1.2-1.2 1.8-1.8c.4-.4.4-1 0-1.4s-1-.4-1.4 0L45.4 43l-1.8-1.8.8-.8c.4-.4.4-1 0-1.4s-1-.4-1.4 0l-.8.8L40.5 38l1.8-1.8c.4-.4.4-1 0-1.4s-1-.4-1.4 0L39 36.6l-1.8-1.8L38 34c.4-.4.4-1 0-1.4s-1-.4-1.4 0l-.8.8-1.8-1.8 1.8-1.8c.4-.4.4-1 0-1.4s-1-.4-1.4 0l-1.8 1.8-1.8-1.8.8-.8c.4-.4.4-1 0-1.4s-1-.4-1.4 0L29.4 27l-1.8-1.8 1.8-1.8c.4-.4.4-1 0-1.4s-1-.4-1.4 0l-1.8 1.8L24.5 22l.8-.8c.4-.4.4-1 0-1.4s-1-.4-1.4 0L23 20.6l-1.8-1.8 1.8-1.8c.4-.4.4-1 0-1.4s-1-.4-1.4 0l-1.8 1.8-1.8-1.8.8-.8c.4-.4.4-1 0-1.4s-1-.4-1.4 0l-.8.8L15.5 13 20 8.4 52.6 41 48.1 45.6z"></path></svg>                            <span className='font-bold'> {property?.personCanStay}</span>
    ...
    {role === "partner" || role === "user" && Premium?.subscription?.planType ? (
        ...
        <div className='flex flex-col bg-gradient-to-b from-gray-800 to-white w-full h-40 items-center justify-center text-white'>
            <h1 className='text-xl font-bold '>
                Would you like to access additional details? Just upgrade to premium.
            </h1>
            <button className="relative w-32 p-2 h-12 bg-black text-white border-none rounded-md text-xl font-bold cursor-pointer z-10 group overflow-hidden" onClick={() => {
                user ? navigate('/subscription') : document.getElementById('my_modal_3').showModal();
            }}>
                Premium
                <span className="absolute w-36 h-32 -top-8 -left-2 bg-gradient-to-r from-sky-200 to-sky-400 rotate-12 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-right"></span>
                <span className="absolute w-36 h-32 -top-8 -left-2 bg-gradient-to-r from-sky-400 to-sky-600 rotate-12 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-700 origin-right"></span>
                <span className="absolute w-36 h-32 -top-8 -left-2 bg-gradient-to-r from-sky-600 to-sky-800 rotate-12 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-1000 origin-right"></span>
                <span className=" flex-col group-hover:opacity-100 opacity-0 absolute top-2.5 left-6 z-10 transition-opacity duration-1000">Get Now</span>
            </button>
